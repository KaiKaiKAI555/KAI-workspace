		...
		<view v-show="showUp" class="contentDetail" style="display: flex; flex-direction: column;">
			...
			<view style="background-color: #397a62; border-radius: 20rpx; margin-top: 0rpx;margin: 10rpx; background: rgba(179, 194, 186, 0.6)">
				<view style="display: flex; margin: 20rpx;">
					<image
					src="@/static/img/plate21.jpg" 
					mode="widthFix" 
					style="width: 400%; border-radius: 15rpx; margin: 0 10rpx;"></image>
					<view style="margin-top: 20rpx;">
						<view style="font-size: 35rpx; font-weight: bold; text-align: center; margin: 10rpx;">《成竹在胸·盘》</view>
						<view style="margin:0 20rpx; margin-bottom: 0rpx;">传统器型，天青釉色。设计创新在于回纹与书法装饰，节选苏东坡《文与可画筼筜谷偃竹记》一文，书作圆润简练，端庄雅健。哥窑施釉处裂纹细腻自然，冰清玉洁的釉质感传达出一种高风亮节的意境。</view>
						<view style="display: flex; justify-content: center; height: 10rpx;"><image src="@/static/img/boader/boat.png" mode="widthFix" style="width: 90%;"></image></view>
					</view>
				</view>
			</view>
			<view>
			...
			<view style="background: rgba(179, 194, 186, 0.6); margin-top: 0rpx; margin: 10rpx; border-radius: 20rpx;">
				<view style="display: flex; justify-content: center;">
					<image src="@/static/img/plate22.jpg" mode="widthFix" style="width: 95%; border-radius: 15rpx; margin-top: 20rpx;"></image>
				</view>
				<view style="display: flex; justify-content: space-between; margin: 20rpx;">
					<image src="@/static/img/plate23.jpg" mode="widthFix" style="width: 48%; border-radius: 15rpx;"></image>
					<image src="@/static/img/plate25.jpg" mode="widthFix" style="width: 50%; border-radius: 15rpx;"></image>
				</view>
			</view>
			<view style="display: flex; justify-content: center;">
				<image 

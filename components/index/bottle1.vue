		...
		<view v-show="showUp" class="contentDetail" style="display: flex; flex-direction: column;">
			...
			<view style="background-color: #397a62; border-radius: 20rpx; margin-top: 0rpx;margin: 10rpx; background: rgba(179, 194, 186, 0.6)">
				<view>
					<view style="display: flex; margin: 10rpx;">
						<image
						src="@/static/img/bottle11.jpg" 
						mode="widthFix" 
						style="width: 450%; border-radius: 15rpx; margin-right: 10rpx; margin-top: 50rpx;"></image>
						<view style="margin-top: 30rpx;">
							<view style="font-size: 35rpx; font-weight: bold; text-align: center; margin-bottom: 10rpx;">《上善若水》</view>
							<view style="margin: 0 10rpx; text-indent: 2em;">上善若水，语出老子，意“水善利万物而不争”，借指德之高尚。此作通体施以龙泉粉青厚釉，釉下雕刻上善若水四字，再配以瓯江溪鱼，构图别致新颖。在“类玉如冰”的釉色中传达出水造福万物，滋养万物，却不与万物争高下，为注入万物生命活力的崇高与纯美。</view>
							<view style="display: flex; justify-content: flex-end; height: 150rpx;"><image src="@/static/img/boader/montain.png" mode="widthFix" style="width: 50%;"></image></view>
						</view>
					</view>
				</view>
			</view>
			...
			<view style="background: rgba(179, 194, 186, 0.6); margin-top: 0rpx; margin: 10rpx; border-radius: 20rpx;">
				<view style="display: flex; justify-content: center;">
					<image src="@/static/img/bottle15.jpg" mode="widthFix" style="width: 95%; border-radius: 15rpx; margin-top: 20rpx;"></image>
				</view>
				<view style="display: flex; justify-content: space-between; margin: 20rpx;">
					<image src="@/static/img/bottle12.jpg" mode="widthFix" style="width: 48%; border-radius: 15rpx;"></image>
					<image src="@/static/img/bottle13.jpg" mode="widthFix" style="width: 50%; border-radius: 15rpx;"></image>
				</view>
			</view>
			<view style="display: flex; justify-content: center;">
				<image 

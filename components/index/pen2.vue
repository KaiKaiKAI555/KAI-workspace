		...
		<view v-show="showUp" class="contentDetail" style="display: flex; flex-direction: column;">
			...
			<view style="background-color: #397a62; border-radius: 20rpx; margin-top: 0rpx;margin: 10rpx; background: rgba(179, 194, 186, 0.6)">
				<view>
					<view style="display: flex; margin: 10rpx;">
						<image
						src="@/static/img/pen21.jpg" 
						mode="widthFix" 
						style="width: 200%; border-radius: 15rpx; margin-right: 10rpx; margin-top: 10rpx;"></image>
						<view>
							<view style="font-size: 35rpx; font-weight: bold; text-align: center; margin-bottom: 10rpx;">《书谱》</view>
							<view> 此作为传统器笔筒，刷涂紫金土，镌刻书法纹饰，装饰灵感来源于中国传统古文字竹简书法的表现形式，将龙泉青瓷的玉润含蓄，与竹简书法的朴实上古结合，以刀代笔，刻孙过庭《书谱》，整体一气呵成，端庄大气，古意满溢。</view>
						</view>
					</view>
				</view>
				<view style="display: flex; justify-content: flex-end;"><image src="@/static/img/boader/mei2.png" mode="widthFix" style="width: 70%;"></image></view>
				<view style="display: flex; margin: 10rpx;margin-top: 20rpx;">
					<view>
						<view style="font-size: 35rpx; font-weight: bold; text-align: center; margin-bottom: 10rpx;">《不可居无竹》</view>
						<view style="margin: 10rpx; text-indent: 2em;">竹号君子，亦刚亦柔。世人赏其摇曳青翠，赞其凌雪不凋，叹其伐可复生，恋其淡泊明志。东坡语：不可居无竹，无竹令人俗。</view>
						<view style="margin: 10rpx; text-indent: 2em;">此作品取形于“竹”，以黄金比例竹节为饰，口沿上双线精致紫金线；罩施梅子青釉；底部刷涂紫金化妆土，镌刻印记，露出朱砂胎原色，签“不可居无竹”，形有尽，而意无穷！</view>
					</view>
					<image src="@/static/img/pen22.jpg" mode="widthFix" style="width: 200%; border-radius: 15rpx;"></image>
				</view>
			</view>
			<view>
			...
			<view style="background: rgba(179, 194, 186, 0.6); margin-top: 0rpx; margin: 10rpx; border-radius: 20rpx;">
				<view style="display: flex; justify-content: center;">
					<image src="@/static/img/pen25.jpg" mode="widthFix" style="width: 95%; border-radius: 15rpx; margin-top: 20rpx;"></image>
				</view>
				<view style="display: flex; justify-content: space-between; margin: 20rpx;">
					<image src="@/static/img/pen24.jpg" mode="widthFix" style="width: 48%; border-radius: 15rpx;"></image>
					<image src="@/static/img/pen23.jpg" mode="widthFix" style="width: 50%; border-radius: 15rpx;"></image>
				</view>
			</view>
			<view style="display: flex; justify-content: center;">
				<image 

		...
		<view v-show="showUp" class="contentDetail" style="display: flex; flex-direction: column;">
			...
			<view style="background-color: #397a62; border-radius: 20rpx; margin-top: 0rpx;margin: 10rpx; background: rgba(179, 194, 186, 0.6)">
				<view style="display: flex; margin: 10rpx;">
					<image 
					src="@/static/img/cha11.jpg" 
					mode="widthFix" 
					style="width: 500%; border-radius: 15rpx;"></image>
					<view style="margin-left: 10rpx;">此组茶器，包含天青壶与壶承两件；天青壶，汝浊釉层，翠媲美玉，看似无饰却极致。出水极佳，封口断水。壶顶、壶盖、壶身、壶底造型丰满圆润至极，茶道相抚，道器天成。与传统茶壶有别，以圈底满釉裹足，圈内手刻回纹托底烧制。</view>
				</view>
				<view style="display: flex; margin: 10rpx; margin-top: 20rpx;">
					<view style="margin-left: 10rpx;">壶承，中间凹施乳浊青釉，厚似凝脂，沿呈书法镌刻，阳刻纹饰，施草木灰釉。将天青壶放于壶承之上，两者相互对比、衬托，幡然成趣，浑然天成。</view>
					<image 
					src="@/static/img/cha12.jpg" 
					mode="widthFix" 
					style="width: 500%; border-radius: 15rpx; align-self: center;"></image>
				</view>
			</view>
			<view>
			...
			<view style="background: rgba(179, 194, 186, 0.6); margin-top: 0rpx; margin: 10rpx; border-radius: 20rpx;">
				<view style="display: flex; justify-content: center;">
					<image src="@/static/img/cha13.jpg" mode="widthFix" style="width: 95%; border-radius: 15rpx; margin-top: 20rpx;"></image>
				</view>
				<view style="display: flex; justify-content: space-between; margin: 20rpx;">
					<image src="@/static/img/cha14.jpg" mode="widthFix" style="width: 48%; border-radius: 15rpx;"></image>
					<image src="@/static/img/cha15.jpg" mode="widthFix" style="width: 50%; border-radius: 15rpx;"></image>
				</view>
			</view>
			<view style="display: flex; justify-content: center;">
				<image 
